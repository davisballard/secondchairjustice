...
Right now, geo-exclusivity isn't clearly defined for multi-location firms. Jacoby & Meyers gets whole-state exclusivity (CA, CO, NV, WA) — one contract, one firm, entire state locked. That model made sense to close a large anchor client, but we're now reaching out to firms that span multiple cities and multiple states, and the question isn't answered:

**If a law firm has offices in Los Angeles, San Francisco, and San Diego — do they get all of California? Just those three metros? Something else? And what do we charge?**

This needs to be settled before we scale outreach, because we're going to get this question constantly from larger prospects, and our answer determines both our revenue ceiling and our competitive positioning.

---

## Critical Distinction: "Exclusive Leads" vs. "Exclusive Territory"

Before getting into the per-state vs. per-metro debate, it's important to name the distinction that separates Second Chair from almost every competitor in the space.

**Exclusive lead** — The same individual lead record isn't sold to two buyers. A firm gets the contact info, no one else gets that same contact info. This is what Legal Brand Marketing, Ngage, and most "exclusive" lead vendors actually sell.

**Exclusive territory** — No competing firm in your market can buy from this vendor at all. If you're the exclusive client for Los Angeles, your competitor cannot become a client in Los Angeles. Ever.

These sound similar. They are not.

Legal Brand Marketing's own Terms of Service (updated January 2026) makes this explicit:

> *"Contacts in Kentucky will be delivered to the Participant on an exclusive basis, however, the Participant does not have exclusive territorial rights."*

That means two competing PI firms in Louisville can both be buying "exclusive" leads from LBM simultaneously. They never get the same lead record — but they are both buying from the same inventory, through the same funnel, targeting the same pool of injured consumers. They are functionally competing through the same vendor.

**Second Chair offers exclusive territory. Almost no one else does.** The only direct competitor with a comparable model is Taqtics — and they're CTV-focused (brand awareness), not bottom-of-funnel lead gen.

This distinction is a sales argument, not just a positioning statement. When a prospect says "Legal Brand Marketing sells exclusive leads," the correct response is: "They sell exclusive lead records. We sell an exclusive market. Two firms in Los Angeles can both be LBM clients. Only one firm in Los Angeles can be a Second Chair client."

---

## The Core Question

> **How do we define geo-exclusivity for multi-location firms — and what should our standard territory unit be?**
...
3. **For multi-state firms:** If a firm operates in 5 states, are they buying 5 market exclusivities? A custom multi-state package? Something else entirely?
...
## What's at Stake: Revenue Ceiling by Territory Model

This is not just a pricing question — the choice of territory unit directly determines the maximum number of clients we can ever have nationally, which determines our revenue ceiling.

**The three models and their ceilings:**
...
## The Three Territory Unit Options

### Option 1: Per-State (Current Jacoby Model)

**Pros:**
- Simple to pitch and explain — law firms understand state-level licensing and advertising
- Appeals to large regional firms who operate statewide
- One contract, one relationship, easier to manage
- State lines are legally unambiguous

**Cons:**
- **Revenue ceiling of $40–60M nationally** — far below the real opportunity
- Massive opportunity cost: a state-wide lock blocks all other firms in that state, even in markets the client never serves
- No relationship to actual service area — a firm with offices in LA and SF doesn't serve Fresno
- Creates a precedent that every large prospect will expect to replicate
- **Caps us at 50 clients nationally**
...
## The Multi-Location Firm Scenarios

### Scenario A: Multi-City, Same State
...
- Appeals to large regional firms
- Legally unambiguous
- One relationship per state

**Cons:**
- Caps revenue at $40–60M nationally (50 clients max)
- Blocks markets the client never serves
- No pricing logic for state size variation (CA vs. CO treated identically)
- Sets a precedent that every large prospect expects to replicate
...
*See also: [COMPETITOR_GEO_EXCLUSIVITY_ANALYSIS.md](COMPETITOR_GEO_EXCLUSIVITY_ANALYSIS.md)*
